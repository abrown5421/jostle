...
const LINK_CLASS =
  'cursor-pointer text-content-primary transition-colors hover:text-accent';
...
function AvatarButton({
  ...
  return (
    <span className="relative inline-flex">
      ...
      {badge ? (
        <span className="absolute bottom-0 right-0 inline-flex">{badge}</span>
      ) : null}
    </span>
  );
}
    ...
    >
      <div className="flex items-center gap-2">
        ...
        <span
          ...
          style={
            appNameFontFamily ? { fontFamily: appNameFontFamily } : undefined
          }
        >
          {appName}
        </span>
